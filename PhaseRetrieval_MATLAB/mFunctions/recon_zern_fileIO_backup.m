function [coeffsOut, cRMSE, cTime] = recon_zern_fileIO(fileFolderOut,fileFolderIn, fileName, imgNum, repNum,...
    zernCoeffOrder, iteration, gamma, cropSize, bgValue,flagShowInput, flagShowRecon, flagGPU,penalChioce)
...
[cEstimate, imgEstimate, ~] = recon_zern(imgs, pIn, coeffs_delta, gamma,...
    iteration, zernSteps, pixelSize, lambda, NA, flagGPU, penalChioce);
