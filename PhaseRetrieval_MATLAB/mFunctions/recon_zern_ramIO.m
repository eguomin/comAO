function [coeffsOut, cRMSE, cTime] = recon_zern_ramIO(fileFolderOut,imgsRaw, coeffsRaw, imgNum, repNum,...
...
% imgsRaw: input raw images; % corresponding to previous TIFF file
% coeffsRaw: input coefficients; % corresponding to previous coefficients file
