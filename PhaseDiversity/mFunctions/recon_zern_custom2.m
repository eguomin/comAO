function [cEstimate, imgEstimate, rePar] = recon_zern_custom2(imgs, p, waveFront_deltas, gamma,...
    alpha, itLimit, zernSteps, pixelSize, lambda, NA, GPUflag, penalChioce,rotAng, cIn)
% reconstruct the zernike coefficients of aberrated phase 
% based on phase diversity images and upboosting strategy
% 1) diversity phased customed by wavefront instead of Zernike coefficients
% 2) Object are customed by point source (zernretrieve_loop_custom)
% 
% Output
...
%   waveFront_deltas: a matrix (known aberration) of wavefronts/phases
%   (unit: rad); if matrix, the thir dimension should be N
...
for iStep = 1:stepNum
    ...
    [cEstimate, imgEstimate, J, itTotal, cInter] = zernretrieve_loop_custom(imgDs,...
